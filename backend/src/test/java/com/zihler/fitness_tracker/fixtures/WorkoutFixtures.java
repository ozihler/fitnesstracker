...
public class WorkoutFixtures {
    public final static Workout FULL_WORKOUT = new Workout(WorkoutId.of("1-1"), CreationDate.of(LocalDate.of(2019, 12, 10)), WorkoutTitle.of("W Chest Triceps"), MuscleGroups.muscleGroups(
            new MuscleGroup(
                    Name.of("Chest"),
                    Exercises.of(
                            new Exercise(
