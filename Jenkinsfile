    ...
    stages {
        ...
        stage("Deploy to staging") {
            steps {
                ...
                // sudo docker stop /fitnesstracker || true && sleep 10 && sudo docker run -d --rm -p 8091:5000 -v /var/services/homes/alioli/Drive/fitness-tracker:/root/fitness-tracker --name fitnesstracker ozihler/fitnesstracker:1
            }
        }
    }
}
